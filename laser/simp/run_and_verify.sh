...
./maplesat -lsr-out=lsr -all-dec-out=alldecs -lsr-num -ccmin-mode=2 -always-restart -conf-side-lsr -verb=0 $1 -lsr-final-deps=deps
#~/git/smtBD/deps/open-wbo/openwbo deps > 
...
#./maplesat -lsr-in=lsr_deps  -lsr-cert-cls-out=clauses -lsr-num -ccmin-mode=2 -always-restart -conf-side-lsr -verb=0 $1
#./maplesat -lsr-in=lsr_deps  -lsr-cert-cls-in=clauses -never-gc -lsr-num -ccmin-mode=2 -always-restart -conf-side-lsr -verb=0 $1
