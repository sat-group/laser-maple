...
case "$1" in 
	...
	glucose4.0)
    echo "Cleaning Open-WBO (with glucose4.0)"
	make VERSION=core SOLVERNAME="Glucose4.0" SOLVERDIR=glucose4.0 NSPACE=Glucose clean;;
    glucose3.0)
	...
	1430)
    echo "Cleaning Open-WBO with minisat hack1430"
	make VERSION=core SOLVERNAME="Minisat.hack1430" SOLVERDIR=1430 NSPACE=Minisat clean;;
	swd)
    echo "Cleaning Open-WBO with SWDiA5BY A26"
	make VERSION=core SOLVERNAME="SWDiA5BY.A26" SOLVERDIR=swd NSPACE=Minsat clean;;
	blbd)
	echo "Cleaning Open-WBO with minisat blbd"
	make VERSION=core SOLVERNAME="minisat.blbd" SOLVERDIR=blbd NSPACE=Minisat clean;;
    all)
	...
	make VERSION=simp SOLVERNAME="GlucoRed" SOLVERDIR=glucored NSPACE=Minisat clean
	make VERSION=core SOLVERNAME="Minisat.hack1430" SOLVERDIR=1430 NSPACE=Minisat clean
	make VERSION=core SOLVERNAME="SWDiA5BY.A26" SOLVERDIR=swd NSPACE=Glucose clean
	make VERSION=core SOLVERNAME="blbd" SOLVERDIR=blbd NSPACE=Minisat clean;;
